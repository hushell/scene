function [wt,td,E] = plsa(x,y,T,C,epsilon,plo)
...
for c = 1:C
    ...
    [wt{c},td{c},E{c}] = plsa_encap(counts,T,epsilon,plo);
end


function [wt,td,E] = plsa_oneclass(x,T,epsilon,plo)
...
for r = 1:R
    counts(:,(r-1)*I+1:r*I) = x(:,r:R:end-(R-r));
end

[wt,td,E] = plsa_encap(counts,T,epsilon,plo);
